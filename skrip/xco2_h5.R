...
setwd("~/Documents/SATELLITE/OCO-2/h5/data/")  # adjust to the right directory
year <- "22" # Use only two last digits of the year
month <- "06"
fpath <- getwd()
...
co2df_sub <- subset(co2df, lat >= -15 & lat <= 10 & lon >= 90 & lon <= 145)
